    ...
    return (
        <div className = 'core-div-1'>
            <div className = 'core-div-2 core-div-2-img1'>
                <h3 className = 'core-h3'>Dashboard Implementation<br/><br/></h3>
                <p className = 'core-p-1'>Key Skills : ReactJS, JavaScript</p>
                <p className = 'core-p-2'>Highlights : Development and maintenance</p>
            </div>
            <div className = 'core-div-2 core-div-2-img2'>
                <h3 className = 'core-h3'>Portfolio Webapp<br/><br/></h3>
            ...
            <div className = 'core-div-2 core-div-2-img5'>
            ...
            <div className = 'core-div-2 core-div-2-img6'>
